...
- [§3.3.2.2 L1059](https://github.com/OpenJobDescription/openjd-specifications/blob/mainline/wiki/2023-09-Template-Schemas.md?plain=1#L1059) `<AttributeCapabilityValue>` constraints apply AFTER the format string resolves
...
- [§2.3 L318](https://github.com/OpenJobDescription/openjd-specifications/blob/mainline/wiki/2023-09-Template-Schemas.md?plain=1#L318) `<intstring>` is a string representation of an integer in base-10
